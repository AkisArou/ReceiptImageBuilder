...
var ReceiptImageBuilder = /** @class */ (function () {
    ...
    * */
    ...
    ReceiptImageBuilder.prototype.makeParentPrintReady = function () {
    ...
    * */
    ReceiptImageBuilder.prototype.generatePrintableElement = function () {
        var _this = this;
        this.makeParentPrintReady();
        document.body.appendChild(this.parent);
        return function () { return _this.parent.remove(); };
    };
    /*
    * Can set image type (PNG, JPEG). Defaults to PNG.
    * Returns Promise with HTMLImageElement.
    * */
    ReceiptImageBuilder.prototype.getHTMLImage = function (type) {
